...
import mona.project.guideme.view.fragment.userCycle.UserTripDetailsFragment;
...
public class UserTripAdapter extends RecyclerView.Adapter<UserTripAdapter.ViewHolder> {
    ...
    public UserTripAdapter(Activity activity, List<TripModel> tripList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.tripLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                UserStartActivity userStartActivity = (UserStartActivity) context;
                UserTripDetailsFragment tripReservationFragment = new UserTripDetailsFragment();
                ...
                bundle.putString("tripTime",time);
                ...
                tripReservationFragment.setArguments(bundle);

                replaceFragment(userStartActivity.getSupportFragmentManager(),R.id.user_container, tripReservationFragment);
            }
        });
    }
